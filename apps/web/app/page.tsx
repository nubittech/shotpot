      ...
      <section id="how" style={{ padding: "100px 0", position: "relative" }}>
        <div className="container" style={{ maxWidth: 1240, margin: "0 auto", padding: "0 32px" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(30px,5vw,52px)", letterSpacing: "0.16em", color: C.b300, textTransform: "uppercase", lineHeight: 1.05 }}>{landing.how.eyebrow}</div>
