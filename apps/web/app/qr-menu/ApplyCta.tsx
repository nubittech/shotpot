  ...
  return (
    <>
      ...
      {open && typeof document !== "undefined" && createPortal(
        <div onClick={() => setOpen(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.8)", zIndex: 1000, display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "40px 16px", overflowY: "auto" }}>
          <div onClick={(e) => e.stopPropagation()} style={{ width: "100%", maxWidth: 520, background: "#141210", border: "1px solid rgba(232,200,118,0.25)", borderRadius: 20, padding: 26, position: "relative", fontFamily: "var(--font-inter), Inter, system-ui, sans-serif" }}>
