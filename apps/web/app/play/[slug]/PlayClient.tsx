...
const WHEEL_THEMES: Record<WheelVariantDB, Theme> = {
  ...
  /* ── Café Lumière — bordeaux + brass on dark walnut ── */
  paris: {
    bg:              "radial-gradient(140% 100% at 50% 0%, #2c1a14 0%, #1a0e08 60%, #0c0604 100%)",
    cardBg:          "rgba(184,138,58,0.07)",
    ctaCardBg:       "linear-gradient(135deg, #7a1f2b 0%, #b88a3a 100%)",
    ctaCardBgIdle:   "rgba(184,138,58,0.05)",
    navBg:           "rgba(12,6,4,0.95)",
    text:            "#fbf5e6",
    muted:           "rgba(228,193,114,0.55)",
    ctaText:         "#fbf5e6",
    ctaMuted:        "rgba(251,245,230,0.7)",
    accent:          "#e4c172",
    accent2:         "#b88a3a",
    border:          "rgba(228,193,114,0.18)",
    ctaBorder:       "#7a5a1a",
    glow:            "rgba(228,193,114,0.32)",
    jackpotGlow:     "rgba(228,193,114,0.55)",
    jackpotHi:       "#e4c172",
    jackpotLo:       "#7a1f2b",
    jackpotRim:      "#7a5a1a",
    btnBg:           "#7a1f2b",
    ...
    nameSize:        "clamp(32px, 9vw, 50px)",
    labelText:       "CHEZ NOUS",
    receiptTint:     "linear-gradient(180deg,rgba(228,193,114,0.08),rgba(122,31,43,0.04))",
    jackpotBg:       "radial-gradient(circle at 35% 30%, #e4c172 0%, #7a1f2b 100%)",
  },

  /* ── Tatlı Atölye — blush pink + raspberry on cocoa dark ── */
  chalk: {
    bg:              "radial-gradient(140% 100% at 50% 0%, #2a1418 0%, #1a0a10 60%, #0c0508 100%)",
    cardBg:          "rgba(244,185,197,0.07)",
    ctaCardBg:       "linear-gradient(135deg, #f4b9c5 0%, #b03a5b 100%)",
    ctaCardBgIdle:   "rgba(244,185,197,0.05)",
    navBg:           "rgba(12,5,8,0.95)",
    text:            "#fbeef0",
    muted:           "rgba(240,200,120,0.55)",
    ctaText:         "#ffffff",
    ctaMuted:        "rgba(255,255,255,0.75)",
    accent:          "#f4b9c5",
    accent2:         "#f0c878",
    border:          "rgba(244,185,197,0.2)",
    ctaBorder:       "#b03a5b",
    glow:            "rgba(244,185,197,0.32)",
    jackpotGlow:     "rgba(240,200,120,0.55)",
    jackpotHi:       "#f0c878",
    jackpotLo:       "#b03a5b",
    jackpotRim:      "#5a3a2a",
    btnBg:           "#b03a5b",
    btnText:         "#ffffff",
    fontDisplay:     "'Caveat', 'Pacifico', cursive",
    fontLabel:       "'Nunito', sans-serif",
    nameTransform:   "capitalize",
    nameSize:        "clamp(42px, 11vw, 60px)",
    labelText:       "bugün",
    receiptTint:     "linear-gradient(180deg,rgba(244,185,197,0.08),rgba(240,200,120,0.04))",
    jackpotBg:       "radial-gradient(circle at 35% 30%, #f0c878 0%, #b03a5b 100%)",
  },
};
